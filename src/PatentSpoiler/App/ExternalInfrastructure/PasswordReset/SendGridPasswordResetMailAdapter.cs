...
{
    public class SendGridPasswordResetMailAdapter : IPasswordResetMailAdapter
    {
        public void Send(string email, string name, string link)
        {
            ...
            {
                From = new MailAddress("noreply@patent-spoiler.net", "Patent-Spoler"),
                Subject = "Patent-Spoiler password reset request",
                Html = " "
            };
